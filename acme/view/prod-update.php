...
<head>
    ...
    <title><?php if(isset($prodInfo['invName'])){ 
      ...
      elseif(isset($invName)) { echo $invName; }?>ACME | Template</title>
...
<body>
    <div id="content">
       ...
       elseif(isset($invName)) { echo $invName; }?></h1>
            <h2>Modify a new product below. All fields are required!</h2>
            <?php
            if (isset($message)) {
                echo $message;
            }
            ...
            <form action="/acme/products/" method="post">
                <fieldset>
                    ...
                    <input id="invThumb" type="text" name="invThumb"  value="/acme/images/no-img.png" <?php if (isset($invThumb)) {
                                                                                                                        echo "value='$invThumb'";
                                                                                                                    }elseif(isset($prodInfo['invThumb'])) {
                                                                                                                        echo "value='$prodInfo[invThumb]'"; } ?> required>
                    <br>
