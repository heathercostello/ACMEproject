    ...
    <div id="content">
        ...
        <main>
								<form method="post" action="/acme/reviews/index.php">
                                                <h1><?php echo "Delete $review[invName] Review"; ?></h1>
                                                <h2>If you delete your review, it will be permanent!</h2>
										<?php if (isset($message)) { echo $message; } ?>
										<label for="reviewText" ><?php echo date('M n, Y', strtotime($review['reviewDate'])); ?></label><br>
										<textarea name="reviewText" id="reviewText" title="Review Text" readonly><?php 
